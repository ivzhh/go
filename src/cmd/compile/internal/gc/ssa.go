...
var opToSSA = map[opAndType]ssa.Op{
	...
	opAndType{OADD, TFLOAT32X4}: ssa.OpAdd128F,
	...
	opAndType{OSUB, TFLOAT32X4}: ssa.OpSub128F,
	...
	opAndType{OMUL, TFLOAT32X4}: ssa.OpMul128F,

	opAndType{ODIV, TFLOAT32}:   ssa.OpDiv32F,
	opAndType{ODIV, TFLOAT64}:   ssa.OpDiv64F,
	opAndType{ODIV, TFLOAT32X4}: ssa.OpDiv128F,
